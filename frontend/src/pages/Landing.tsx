...
const translations = {
  en: {
    ...
    heroSubtitle: 'VitaScribe is your AI-powered medical scribe that transforms clinical indications into comprehensive reports in seconds. Because you became a doctor to diagnose and heal, not to battle documentation backlogs.',
    signIn: 'Sign In',
    ...
    testimonialsSubtitle: 'Join healthcare professionals who\'ve reclaimed their time and passion for patient care',
  ...
  fr: {
    ...
    heroSubtitle: "VitaScribe est votre assistant IA médical qui transforme les indications cliniques en rapports complets en quelques secondes. Parce que vous êtes devenu médecin pour diagnostiquer et soigner, pas pour combattre les retards de documentation.",
    signIn: 'Se Connecter',
    ...
    testimonialsSubtitle: 'Rejoignez les professionnels de santé qui ont retrouvé leur temps et leur passion pour les soins aux patients',
